<%-- 
    Document   : myProducts
    Created on : Dec 20, 2015, 4:10:40 PM
			...
			<div class="table-responsive cart_info">
					...
					<tbody>
							...
							<td class="cart_product">
                                                            <a href=""><img src="<c:out value="${product.productImage}"/>" alt=""></a>
							</td>
							<td class="cart_name">
							...
							<td class="cart_description">
                                                        ...
                                                        <td class="cart_btnDelete">
                                                            <button href="HandlerController?action=deleteProduct&idProduct=<c:out value="${product.idProduct}"/>" type="button" class="btn btn-danger">Deletar</button>
                                                        </td>
                                                        <td class="cart_btnUpdate">
